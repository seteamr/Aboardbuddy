          ...
          <div class="row top_tiles">
			...
			<div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
              <div class="tile-stats newc Agent-Revenue">
                <div class="count"><?php echo $total_commision_d; ?></br>Agent Revenue</div>
			...
			<div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
              <div class="tile-stats newc Agent-Coins">
                <div class="count"><?php echo $current_balances_d; ?></br>Agent Coins</div>
            ...
            <div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
              <div class="tile-stats newc Client-Coins">
                <div class="count"><?php echo $current_balances_r; ?></br>Client Coins</div>
			...
			<!--<div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
              <div class="tile-stats">
                ...
                <div class="count"><?php echo count($retailers); ?></div>
			...
			<div class="animated flipInY col-lg-4 col-md-4 col-sm-6 col-xs-12">
              <div class="tile-stats">
                ...
                <div class="count"><?php echo count($distributersss); ?></div>
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <table class="align-middle mb-0 table table-borderless table-striped table-hover">
						...
						<tr id="<?php echo $retailer->user_master_id; ?>" <?php echo $color; ?> >
							...
							?>
							<td class="text-center"><a href="<?php echo base_url('users/edit/'.$retailer->user_master_id); ?>"  ><?php echo $retailer->user_name; ?> (<?php echo $retailer->name; ?>) </a></td>
							...
							<td class="text-center"><div class=""><?php echo $commision; ?></div></td>
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <table class="align-middle mb-0 table table-borderless table-striped table-hover">
							...
							<tr>
								<th class="text-center">#</th>
								<th class="text-center">Client</th>
								<th class="text-center">Won Distribute</th>								
								<th class="text-center">Coins</th>
								<th class="text-center">Bet</th>
								<th class="text-center">Won</th>
								<th class="text-center">Remove</th>
