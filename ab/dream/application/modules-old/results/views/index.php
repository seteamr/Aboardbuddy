			...
			<div class="col-lg-12">
				...
				<div class="main-card mb-6 card">
					<div class="card-body"><h5 class="card-title">Search By</h5>
						<div>
							<form class="form-inline" action="<?php echo base_url('results/index') ?>" method="post">
				...
				<div class="row">
						...
						<?php } ?>
							...
							<div style="background:<?php echo $rand_background; ?>;color:#fff;" class="new col-md-1 card-shadow-primary border mb-1 card card-body border-primary"><h5 class="card-title">S<?php echo $tr->series_master_id.'B'.$tr->bajar_master_id.$tr->bid_akada_number; ?></h5></div>
						<?php } ?>
						</div>
