			...
			<div class="col-lg-12">
				...
				<div class="row">
						...
						<?php } ?>
							...
							<div style="background:<?php echo $rand_background; ?>;" class="new col-md-1 card-shadow-primary border mb-1 card card-body border-primary"><h5 class="card-title"><?php echo $tr->series_master_id.$tr->bajar_master_id.$tr->bid_akada_number; ?></h5></div>
						<?php } ?>
						</div>
