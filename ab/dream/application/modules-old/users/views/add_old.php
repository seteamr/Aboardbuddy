<div class="app-main__inner">
		...
		<div class="main-card mb-3 card">
			<div class="card-body">
				...
				<form action="<?php echo base_url(); ?>users/add" class="needs-validation" novalidate method="post" enctype="multipart/form-data">
					<div class="form-row">
						<div class="col-md-4 mb-3">
							<label for="user_name">Full Name </label>
							<input type="text" class="form-control" id="name" name="name" placeholder="Full Name" value="<?php echo set_value('name'); ?>" required>							
						...
						<!--<div class="col-md-4 mb-3">
							...
							<input type="password" class="form-control" id="user_password" name="user_password" placeholder="Enter Password" value="<?php echo set_value('user_password'); ?>" required>
							<span style="color:red;"> 
					...
					<div class="form-row">						
						...
						<div id="user_comission_div" class="col-md-3 mb-3" <?php if(set_value('user_type')=="2" or set_value('user_type')=="1" ){ echo "style='display:block;';"; }else{ echo "style='display:none;';"; } ?> >
							...
							?>
							<input type="number" max="<?php echo $com; ?>" min="0" onkeyup="if(this.value > <?php  echo $com; ?> || this.value < 0) this.value = null;" class="form-control" id="user_comission" name="user_comission" placeholder="Enter Comission" value="<?php echo set_value('user_comission'); ?>" required>							
							<?php }else{ ?>
							<input type="number" max="10.00" min="0" onkeyup="if(this.value > 10 || this.value < 0) this.value = null;" class="form-control" id="user_comission" name="user_comission" placeholder="Enter Comission" value="<?php echo set_value('user_comission'); ?>" required>							
							<?php } ?>
							<span style="color:red;"> 
								<?php echo form_error('user_comission'); ?>
							</span>
						</div>
						<!--<div id="shop_master_id_div" class="col-md-3 mb-3" <?php if(set_value('user_type')=="1" ){ echo "style='display:block;';"; }else{ echo "style='display:none;';"; } ?>>
					...
					<!--	<div class="col-md-4 mb-3">
						...
						<div class="col-md-3 mb-3">
							...
							<input type="number" class="form-control" onkeyup="chk2();" onblur="chk2();" id="winning_distribution" name="winning_distribution" placeholder="Winning Distribution" value="<?php echo set_value('winning_distribution'); ?>">
							<span style="color:red;"> 
						...
						<div class="col-md-3 mb-3">
							...
							<input type="number" class="form-control" onkeyup="chk3();" onblur="chk3();" id="max_winning" name="max_winning" placeholder="Max Winning" value="<?php echo set_value('max_winning'); ?>">
							<span style="color:red;"> 
						...
						<div class="col-md-3 mb-3">
							...
							<input type="number" onkeyup="chk();" onblur="chk();" class="form-control" id="bonus_percent" name="bonus_percent" placeholder="Bonus %" value="<?php echo set_value('bonus_percent'); ?>">
							<span style="color:red;"> 
