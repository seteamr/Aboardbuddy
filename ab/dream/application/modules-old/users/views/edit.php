          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form action="<?php echo base_url(); ?>users/edit/<?php echo $user->user_master_id; ?>" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">

                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Name <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">                        
						<input type="text" class="form-control col-md-7 col-xs-12" id="name" name="name" placeholder="Full Name" value="<?php echo $user->name; ?>" required>							
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">                        
						<input type="text" disabled class="form-control col-md-7 col-xs-12" id="name" name="name" placeholder="Full Name" value="<?php echo $user->user_name; ?>">	
					  </div>
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">                        
						<input type="text" class="form-control col-md-7 col-xs-12" id="user_password" name="user_password" placeholder="Enter Password" value="<?php echo $user->user_password; ?>" required>							
							<span style="color:red;"> 
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">                        
						<select name="user_type" id="user_type" onchange="getreporting_user('<?php echo $user->user_master_id; ?>');"  class="form-control" required>
					...
					<div id="user_comission_div" class="form-group" <?php if($user->user_type=="2" or $user->user_type=="1" ){ echo "style='display:block;';"; }else{ echo "style='display:none;';"; } ?> >
							...
							?>
							<input type="number" max="<?php echo $com; ?>" min="0" onkeyup="if(this.value > <?php  echo $com; ?> || this.value < 0) this.value = null;" class="form-control" id="user_comission" name="user_comission" placeholder="Enter Revenue" value="<?php echo $user->user_comission; ?>" required>							
							<?php }else{ ?>
							<input type="number" max="10.00" min="0" onkeyup="if(this.value > 10 || this.value < 0) this.value = null;" class="form-control" id="user_comission" name="user_comission" placeholder="Enter Revenue" value="<?php echo $user->user_comission; ?>" required>							
							<?php } ?>
							<span style="color:red;"> 
