 <!-- page content -->
  ...
  <!-- gauge js -->
  <script type="text/javascript" src="<?php echo base_url(); ?>css_js/js/gauge/gauge.min.js"></script>
  <script type="text/javascript" src="<?php echo base_url(); ?>css_js/js/gauge/gauge_demo.js"></script>
  ...
  <!-- worldmap -->
  <script type="text/javascript" src="<?php echo base_url(); ?>css_js/js/maps/jquery-jvectormap-2.0.3.min.js"></script>
  <script type="text/javascript" src="<?php echo base_url(); ?>css_js/js/maps/gdp-data.js"></script>
  <script type="text/javascript" src="<?php echo base_url(); ?>css_js/js/maps/jquery-jvectormap-world-mill-en.js"></script>
  <script type="text/javascript" src="<?php echo base_url(); ?>css_js/js/maps/jquery-jvectormap-us-aea-en.js"></script>
  <!-- pace -->
  ...
  <!-- skycons -->
  <script src="<?php echo base_url(); ?>css_js/js/skycons/skycons.min.js"></script>
  <script>
