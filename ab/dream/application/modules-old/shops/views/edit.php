<div class="app-main__inner">
		...
		<div class="main-card mb-3 card">
			<div class="card-body">
				...
				<form action="<?php echo base_url(); ?>shops/edit/<?php echo $shop->shop_master_id; ?>" class="needs-validation" novalidate method="post" >
					<div class="form-row">
						<div class="col-md-4 mb-3">
							<label for="validationCustom01">Shop Name </label>
							<input type="text" class="form-control" id="validationCustom01" name="shop_name" placeholder="Shop Name" value="<?php echo $shop->shop_name; ?>" required>							
						...
						<div class="col-md-4 mb-3">
							...
							<input type="text" class="form-control" id="validationCustom02" name="shop_contact_person" placeholder="Shop Contact Person" value="<?php echo $shop->shop_contact_person; ?>" required>
							<span style="color:red;"> 
						...
						<div class="col-md-4 mb-3">
							...
							<input type="number" class="form-control" id="validationCustom03" name="shop_contact_number" placeholder="Shop Contact Number" value="<?php echo $shop->shop_contact_number; ?>" required>
							<span style="color:red;"> 
					...
					<div class="form-row">
						<div class="col-md-6 mb-3">
							...
							<textarea name="shop_address" id="validationCustom04" placeholder="Shop Address" class="form-control" required><?php echo $shop->shop_address; ?></textarea>
							<span style="color:red;"> 
