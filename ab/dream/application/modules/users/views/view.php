        ...
        <div class="">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2>View Client <small></small></h2>
                 
                  <div class="clearfix"></div>
                </div>
                <div class="x_content">
                  <br />
                  <form action="<?php echo base_url(); ?>users" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">

                    <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Name <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">                        
						<input disabled type="text" class="form-control col-md-7 col-xs-12" id="name" name="name" placeholder="Full Name" value="<?php echo $user->name; ?>" required>							
					 ...
					 <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Client Code <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">                        
						<input disabled type="text" disabled class="form-control col-md-7 col-xs-12" id="name" name="name" placeholder="Full Name" value="<?php echo $user->user_name; ?>">	
					  </div>
                    </div>
					...
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">                        
						<input disabled type="text" class="form-control col-md-7 col-xs-12" id="user_password" name="user_password" placeholder="Enter Password" value="<?php echo $user->user_password; ?>" required>							
							<span style="color:red;"> 
					 ...
					 <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">                        
						<select disabled name="user_type" id="user_type" onchange="getreporting_user('<?php echo $user->user_master_id; ?>');"  class="form-control" required>
							...
							<option value="1" <?php if($user->user_type=="1"){ echo "selected"; } ?> >Client</option>
					...
					<div id="user_comission_div" class="form-group" <?php if($user->user_type=="2" or $user->user_type=="1" ){ echo "style='display:block;';"; }else{ echo "style='display:none;';"; } ?> >
					...
					<div style="display:none">
					 <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Winning Distribution <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">                        
						<input disabled type="number" class="form-control" onkeyup="chk2();" onblur="chk2();" id="winning_distribution" name="winning_distribution" placeholder="Winning Distribution" value="<?php echo set_value('winning_distribution'); ?>">
						<span style="color:red;"> 
					 ...
					 <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Max Winning <span class="required">*</span>
                      </label>
                      <div class="col-md-6 col-sm-6 col-xs-12">                        
						<input disabled type="number" class="form-control" onkeyup="chk3();" onblur="chk3();" id="max_winning" name="max_winning" placeholder="Max Winning" value="<?php echo set_value('max_winning'); ?>">
						<span style="color:red;"> 
					...
					<div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">                        
						<input disabled type="number" onkeyup="chk();" onblur="chk();" class="form-control" id="bonus_percent" name="bonus_percent" placeholder="Bonus %" value="<?php echo "0";//set_value('bonus_percent'); ?>">
						<span style="color:red;"> 
