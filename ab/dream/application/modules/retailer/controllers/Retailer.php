...
class Retailer extends CI_Controller {
	...
	public function index($page = '')
	{
		...
		$player = $this->common_model->getAllwhere('user_master',array('reporting_user_master_id'=>$my_id));
		...
		$data['total_commision'] = $this->common_model->total_comission_data_new($my_downs);
		
		$currentbalances_r = $this->common_model->all_users_current_balance($my_array);		
