		...
		<div class="row">
			...
			<div class="col-md-6 col-xl-4">
				<div class="card mb-3 widget-content bg-night-fade">
					<div class="widget-content-wrapper text-white">
						<div class="widget-content-left">
							<div class="widget-heading">Commision</div>
							<div class="widget-subheading"></div>
						</div>
						<div class="widget-content-right">
							<div class="widget-numbers text-white"><span><?php echo $total_commision; ?></span></div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-md-6 col-xl-4">
				<div class="card mb-3 widget-content bg-midnight-bloom">
					<div class="widget-content-wrapper text-white">
						...
						<div class="widget-content-right">
							<div class="widget-numbers text-white"><span><?php echo $sales -  $winning - $total_commision - $bonus ; ?></span></div>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="card mb-3 widget-content">
					<div class="widget-content-outer">
						<div class="widget-content-wrapper">
							...
							<div class="widget-content-right">
								<div class="widget-numbers text-success"><?php echo count($playersss); ?></div>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="main-card mb-3 card">
					...
					<div class="table-responsive">
						<table class="align-middle mb-0 table table-borderless table-striped table-hover">
							...
							<tbody>
							<?php $sno=1; foreach($players as $retailer){ ?>
