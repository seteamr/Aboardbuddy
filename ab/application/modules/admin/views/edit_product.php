				...
				<div class="x_panel">
					...
					<div class="x_content"><br />
						<form id="demo-form2" action="" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
							...
							<?php $ad = $this->common_model->getsingle('admin', array('admin_id'=>$product->admin_id));?>
							<div class="form-group">
							  ...
							  <select id="admin_id" name="admin_id" class="form-control col-md-7 col-xs-12">
									<option value="<?php echo $ad->admin_id; ?>" ><?php echo $ad->name; ?> </option>
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="name" name="name" value="<?php  echo $product->name; ?>"  placeholder="Plese enter product name"  class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <select id="p_type" name="p_type" class="form-control col-md-7 col-xs-12">
									...
									<option value="<?php echo $p->id; ?>" <?php if($product->p_type==$p->id){ echo "selected"; } ?> >
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="number" id="p_type_qty" name="p_type_qty" value="<?php  echo $product->p_type_qty; ?>"  placeholder="Plese enter product type quantity" class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="number" id="price" name="price" value="<?php  echo $product->price; ?>"  placeholder="Plese enter actual price"  class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="number" id="discount_price" name="discount_price" value="<?php  echo $product->discount_price; ?>"  placeholder="Plese enter discount price"  class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="number" id="delivery_charge" name="delivery_charge" value="<?php  echo $product->delivery_charge; ?>"  placeholder="Plese enter delivery charge"  class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="number" id="qty" name="qty" disabled value="<?php  echo $product->qty; ?>"  placeholder="Plese enter quantity" class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="description" name="description" value="<?php  echo $product->description; ?>"  placeholder="Plese enter description"  class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-3 col-sm-6 col-xs-12">
								<input type="text" id="lat" name="lat" readonly placeholder="Plese enter Latitude" onkeyup="moveMarker();" onblur="moveMarker();" value="<?php echo $product->p_lat; ?>" class="form-control col-md-7 col-xs-12">
								<span style="color:red;"><?php echo form_error('lat'); ?></span>
							  </div>
							  <div class="col-md-3 col-sm-6 col-xs-12">
								<input type="text" id="long" name="long" readonly value="<?php  echo $product->p_long; ?>" onkeyup="moveMarker();" onblur="moveMarker();"  placeholder="Plese enter logitude" class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
									...
									<div class="col-md-6 col-sm-6 col-xs-12" style="padding-bottom: 37px;">
										<?php if($p_images){ foreach($p_images as $pimg){?>
										<?php  if($pimg->images!=''){ ?>
											<img src="<?php echo base_url().'uploads/products/'.$pimg->images; ?>" width="50" height="50">
											<a href="<?php echo base_url('admin/delete_pimg/'.$pimg->id.'/'.$pimg->p_id); ?>" class="btn btn-danger" onclick="return confirm('Are you sure to want to delete this image?')">&#x2715;</a>
										<?php } ?>
										<?php } }?>
							...
							<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
							  <div class="modal-dialog" role="document" style="float: right;">
								<div class="modal-content" style="height: 357px;width: 342px">
								  ...
								  <div class="modal-footer" style="height: 357px;width: 342px">
