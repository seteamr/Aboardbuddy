						...
						<form id="demo-form2" action="" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="name" name="cat_name" value="<?php  echo set_value('cat_name'); ?>"  placeholder="Plese enter category name" required="required" class="form-control col-md-7 col-xs-12">
