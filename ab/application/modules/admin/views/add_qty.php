						...
						<form id="demo-form2" action="" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" id="name" name="name" value="<?php  echo $product->name; ?>" disabled  placeholder="Plese enter product name"  class="form-control col-md-7 col-xs-12">
								<span style="color:red;"><?php echo form_error('name'); ?></span>
							  </div>
							</div>
							
							<div class="form-group">
							  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Current Quantity </label>
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="number" id="qty" name="qty" value="<?php  echo$product->qty; ?>" disabled placeholder="Plese enter quantity" class="form-control col-md-7 col-xs-12">
								<span style="color:red;"><?php echo form_error('qty'); ?></span>
							  </div>
							</div>
							
							<div class="form-group">
							  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Add More Quantity </label>
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="number" id="add_qty" name="add_qty" value="<?php  echo set_value('add_qty'); ?>"  placeholder="Plese enter more quantity" class="form-control col-md-7 col-xs-12">
								<span style="color:red;"><?php echo form_error('add_qty'); ?></span>
							  </div>
							</div>
