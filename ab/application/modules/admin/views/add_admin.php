				...
				<div class="x_panel">
					...
					<div class="x_content"><br />
						<form id="demo-form2" action="" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
							  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Admin Name </label>
							  <div class="col-md-6 col-sm-6 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="email" id="email" name="email" value="<?php  echo set_value('email'); ?>"  placeholder="Plese enter email"  class="form-control col-md-7 col-xs-12">
							...
							<!--<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="number" id="mobile_no" name="mobile_no" value="<?php  echo set_value('mobile_no'); ?>"  placeholder="Plese enter mobile number"  class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="password" id="password" name="password" value="<?php  echo set_value('password'); ?>"  placeholder="Plese enter password" class="form-control col-md-7 col-xs-12">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-6 col-sm-6 col-xs-12">
								<input type="c_password" id="c_password" name="c_password" value="<?php  echo set_value('c_password'); ?>"  placeholder="Plese enter confirm password" class="form-control col-md-7 col-xs-12">
